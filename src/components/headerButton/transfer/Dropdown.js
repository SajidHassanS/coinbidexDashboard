  ...
  return (
    <div className="relative block text-left">
      <div ref={dropdownRef}>
        ...
        >
          <img src={selectedCurrency === "Crypto Wallet" ? "/logonew.png" : coinsData.find(coin => coin.name === selectedCurrency).imageSrc} alt={selectedCurrency} width={40} height={40} className="mr-2" />
