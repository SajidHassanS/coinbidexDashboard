...
const DropdownButton = () => {
  const [selectedCurrency, setSelectedCurrency] = useState("Select network");
  ...
  const handleCurrencyItemClick = (currency) => {
    setSelectedCurrency(currency === selectedCurrency ? "Select network" : currency);
  };
      ...
      <div ref={dropdownRef}>
        ...
        >
          ...
          <div className="flex items-center">
            {selectedCurrency || "Select network"}
          </div>
